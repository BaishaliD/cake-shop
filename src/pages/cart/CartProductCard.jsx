...
export default function CartProductCard({ data }) {
  return (
    <div
      className="w-full h-52 flex my-2 p-4"
      style={{ border: "lightGray solid 1px" }}
    >
      <Image height="100%" src={data.images[0]} className="cover w-1/5" />
      <div className="px-8 py-2 w-3/5">
        ...
        <div className="flex text-accent2 mb-6 text-sm">
          <span className="mr-4">Weight: {"500 gm"}</span>
          <span>Flavour: {"Chocolate"}</span>
        </div>
